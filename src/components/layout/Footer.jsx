        ...
        <div className="footer-container">
          <div className="footer-column">
            ...
            <div className="footer-social-icons">
              <a
                href="https://facebook.com/hoteldnd"
                aria-label="Facebook"
              ...
              <a
                href="https://instagram.com/hoteldnd"
              ...
              <a
                href="https://tiktok.com/@hoteldnd"
                aria-label="TikTok"
                className="social-icon"
              >
                <svg
          ...
          <div className="footer-column">
            ...
            <p className="footer-contact-item">
              ...
              <br />
              +240 555 317 945 | +240 222 629 788
            </p>
            <p className="footer-contact-item">
